...
\begin{lemma}[{\cite[Lemma 2.13]{J}}, {\cite[§§2.3.2]{O2}}]
	Let $d\in\Z_{\geq0}$, $\q\prt d$, then
	\deq{\a_{-\q}\vac=\sum_{\l\prt d}\c_\q^\l v_\l}
\end{lemma}
\todo{add relation with Murnaghan-Nakayama}
...
\deq{(a_\q v_\l,\vac)=(v_\l,a_{-\q}\vac)=\c_\q^\l}
hence
